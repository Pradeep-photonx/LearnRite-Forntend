...
const defaultSchools: SchoolData[] = [
  ...
  },
  {
    id: 6,
    name: "Oakridge International School",
    slug: "oakridge-international-school-2",
    logo: "/api/placeholder/100/100",
    logoAlt: "Oakridge International School Logo",
    location: "Madhapur",
    board: "IB",
  ...
  },
  {
    id: 9,
    name: "Oakridge International School",
    slug: "oakridge-international-school-3",
    logo: "/api/placeholder/100/100",
    logoAlt: "Oakridge International School Logo",
    location: "Madhapur",
    board: "IB",
  ...
  },
  {
    id: 12,
    name: "Oakridge International School",
    slug: "oakridge-international-school-4",
    logo: "/api/placeholder/100/100",
    logoAlt: "Oakridge International School Logo",
    location: "Madhapur",
    board: "IB",
...
const Schools: React.FC = () => {
  ...
  const handleSchoolClick = (school: SchoolData) => {
    // Navigate to school classes page using slug
    navigate(`/schools/${school.slug}`);
  };

  // Filter schools based on search, location, and board
  const filteredSchools = defaultSchools.filter((school) => {
    const matchesSearch = school.name.toLowerCase().includes(searchQuery.toLowerCase());
    const matchesLocation = selectedLocation === "Select Location" || school.location === selectedLocation;
    const matchesBoard = selectedBoard === "Select Board" || school.board === selectedBoard;
          ...
          {filteredSchools.map((school) => (
            <Grid key={school.id} size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <SchoolCard onClick={() => handleSchoolClick(school)}>
                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent:"center", width: "100%", backgroundColor:"#E3E6F633 !important",
                  height:"200px",
                 }}>
                  <SchoolLogo src={school.logo} alt={school.logoAlt || school.name} />
                </Box>
                 <Box sx={{
                  display:"flex",
                  flexDirection:"column",
